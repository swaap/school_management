...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            @if($group)
            <li><a href="{{url('/translations')}}"><i class="fa fa-book"></i> Translation Manager</a></li>
            <li class="active">{{ucwords($group)}}</li>
            @else
            ...
            (function(e, t) {
                ...
                if (n.fire(r, "rails:attachBindings")) {
                    ...
                    r.delegate(n.linkClickSelector, "click.rails", function(r) {
                        ...
                        if (!u && i.is(n.linkDisableSelector))
                            n.disableElement(i);
                        if (i.data("remote") !== t) {
                            if (u && (!s || s === "GET") && !o) {
                                return true
                    ...
                    r.delegate(n.buttonClickSelector, "click.rails", function(t) {
                        ...
                        if (r.is(n.buttonDisableSelector))
                            n.disableFormElement(r);
